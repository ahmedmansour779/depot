...
export default function AddToCart() {
    ...
    return (
        <div className="flex flex-col sm:flex-row sm:gap-0 gap-4 items-center p-4 mt-4 transition-config">
            ...
            <button className="sm:w-fit w-full bg-black hover:opacity-50 text-white text-sm py-4 px-10">ADD TO CART</button>
        </div>
    )
}
